...
void Curso::menuCurso()  //Creaci�n del constructor menuCurso
{
    int opcion;
	char x;
	do
    ...
    //Men� para el modificaci�n e ingreso de Cursos
	cout<<"\t\t\t---------------------------------"<<endl;
 ...
 void Curso::agregarCurso()      //Constructor de la clase Curso, agregarCurso
{
 ...
 void Curso::mostarCurso()        //Creaci�n del constructor de la clase Curso, mostarCursoes
{
	system("cls");  //limpia pantalla
	fstream file;   //crea
	int total=0;
